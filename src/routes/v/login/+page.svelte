<script lang="ts">
    ...
    async function handleLogin001(e: SubmitEvent) {
        e.preventDefault();
        if (!formValid) return;
...
<!-- 亮色系极简容器 -->
<div
    class="login-wrapper min-vh-100 d-flex align-items-center justify-content-center py-5"
>
            ...
            <div class="card-body p-4 p-md-5">
                ...
                <div class="text-center mb-4">
                    ...
                    <p class="text-muted small">
                        Automated Test Suite Control Center
                    </p>
                </div>
                ...
                {#if errorMsg}
                    <div
                        class="alert alert-danger custom-alert d-flex align-items-center justify-content-between mb-4 fade show"
                        role="alert"
                    >
                ...
                <form onsubmit={handleLogin}>
                    ...
                    <div class="mb-4">
                        <label for="captcha" class="form-label custom-label"
                            >图形验证码</label
                        >
                        <div class="row g-2">
                            <div class="col-8">
